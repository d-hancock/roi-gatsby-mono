...
export interface GenericFlyoutMenuItemProps extends React.HTMLProps<HTMLDivElement> {
  name: string,
  description: string,
  href: string,
...
export const GenericFlyoutMenuItem = (props: GenericFlyoutMenuItemProps) => {
...
export default GenericFlyoutMenuItem
